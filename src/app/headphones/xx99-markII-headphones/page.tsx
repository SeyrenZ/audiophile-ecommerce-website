...
const XX99MarkIIProductDetail = () => {
  const productData: ProductDescription = {
    ...
    subImage1: "/xx99-markII-sub-image-1.svg",
    subImage2: "/xx99-markII-sub-image-2.svg",
    subImage3: "/xx99-markII-sub-image-3.svg",
    features:
    ...
    price: "2,999", // put as string to avoid comma for now
    itemsInBox: [
